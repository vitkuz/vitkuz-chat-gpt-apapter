...
This adapter provides a simplified interface to the OpenAI API with support for default configurations and Zod-based structured outputs.
...
You can pass a Zod schema to get parsed, type-safe results.
...
# Original OpenAI Documentation: Structured model outputs
========================
